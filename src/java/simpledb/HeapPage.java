...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        int tupsPerPage = (int) Math.floor((BufferPool.PAGE_SIZE * 8) / (float)(td.getSize() * 8 + 1));
        return tupsPerPage;
    }
    ...
    private int getHeaderSize() {        
        ...
        int headerBytes = (int) Math.ceil(((float)getNumTuples())/8);
        return headerBytes;
    ...
    public Iterator<Tuple> iterator() {
        Iterator<Tuple> it = new Iterator<Tuple>() {
            ...
            public boolean hasNext() {
                return numTuple < getNumTuples()-getNumEmptySlots();
            }
